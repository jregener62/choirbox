...
const PAGE_PAD_X_MM = 18
const PAGE_PAD_BOTTOM_MM = 18
...
const CONTENT_W_PX = (PAGE_W_MM - 2 * PAGE_PAD_X_MM) / MM_PER_PX
const CONTENT_H_PX = (PAGE_H_MM - PAGE_PAD_TOP_MM - PAGE_PAD_BOTTOM_MM - FOOTER_H_MM - FOOTER_GAP_MM) / MM_PER_PX
